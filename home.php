...
<head>
	...
	<link rel="stylesheet" type="text/css" hre="https://maxcdn.bootstrapcdn.com/font-awessone/4.7.0/css/font-awesone.min.css">
							...
							echo"
								<li>
									<div class='rightside-right-chat'>
										<span> $username <small>$msg_date</small> </span><br><br><p>$msg_content</p>
									</div>
								</li>
							";
						}
	...
	<?php
		if(isset($_POST['submit'])){
			...
			if($msg == ""){
				...
				<div class='alert alert-danger'>
				  <strong><center>Message is Too long. se only 100 characters</center></strong>
				</div>
